...
{
  CLog::Log(LOGDEBUG, "Input: IR remote right press (id: 3)");
  switch (sender.state)
  {
    case UIGestureRecognizerStateBegan:
    ...
    case UIGestureRecognizerStateChanged:
    {
      ...
      switch (direction)
      {
        case UIPanGestureRecognizerDirectionUp:
        {
          ...
          {
            CLog::Log(LOGDEBUG, "Input: Siri remote pan up (id: 23) %i",
                      g_xbmcController.inputHandler.inputSettings.siriRemoteVerticalSensitivity);
            keyId = 23;
          }
          break;
        ...
        case UIPanGestureRecognizerDirectionLeft:
        {
          ...
          {
            CLog::Log(LOGDEBUG, "Input: Siri remote pan left (id: 25) %i",
                      g_xbmcController.inputHandler.inputSettings.siriRemoteHorizontalSensitivity);
            keyId = 25;
          }
          break;
